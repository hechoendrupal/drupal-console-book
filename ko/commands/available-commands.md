...
**cache**  |
[cache:rebuild](cache-rebuild.md) | 모든 사이트 캐시를 삭제하고 다시 생성합니다.
**config**  |
[config:delete](config-delete.md) | Delete configuration
[config:diff](config-diff.md) | 디렉토리와 비교한 활성 설정과 다른 설정 항목들을 출력합니다.
[config:edit](config-edit.md) | 선택한 설정을 수정합니다.
...
[debug:config](debug-config.md) | 현재 설정을 보여줍니다.
...
[generate:doc:gitbook](generate-doc-gitbook.md) | 명령어에 대한 문서 생성
...
[generate:theme](generate-theme.md) | 테마를 생성합니다.
...
**locale**  |
[locale:language:add](locale-language-add.md) | 웹사이트에서 사용할 언어를 추가합니다
[locale:language:delete](locale-language-delete.md) | 웹사이트에서 지원하는 언어를 삭제합니다.
