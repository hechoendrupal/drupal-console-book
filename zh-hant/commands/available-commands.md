...
[shell](shell.md) | commands.shell.description
...
[config:validate](config-validate.md) | commands.config.validate.description
**create**  |
...
**database**  |
[database:add](database-add.md) | commands.database.add.description
...
[database:log:poll](database-log-poll.md) | commands.database.log.poll.description
...
[debug:config:validate](debug-config-validate.md) | commands.debug.config.validate.description
...
[debug:entity](debug-entity.md) | commands.debug.entity.description
[debug:event](debug-event.md) | Display current events 
[debug:features](debug-features.md) | commands.debug.features.description
...
[debug:permission](debug-permission.md) | commands.debug.permission.description
...
**entity**  |
[entity:delete](entity-delete.md) | commands.entity.delete.description
**extend**  |
...
**features**  |
[features:import](features-import.md) | commands.features.import.description
**field**  |
[field:info](field-info.md) | commands.field.info.description
**generate**  |
...
[generate:cache:context](generate-cache-context.md) | commands.generate.cache.context.description
...
[generate:plugin:migrate:process](generate-plugin-migrate-process.md) | commands.generate.plugin.migrate.process.description
[generate:plugin:migrate:source](generate-plugin-migrate-source.md) | commands.generate.plugin.migrate.source.description
...
[migrate:rollback](migrate-rollback.md) | commands.migrate.rollback.description
...
**user**  |
[user:create](user-create.md) | commands.user.create.description
