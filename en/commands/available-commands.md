...
[debug:multisite](debug-multisite.md) | List all multi-sites available in system
...
**locale**  |
[locale:language:add](locale-language-add.md) | Add languages to be supported by your site
...
[user:delete](user-delete.md) | Delete users from the application
