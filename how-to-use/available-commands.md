...
```
  ...
  list                            Lists commands
  self-update                     Updates the console to latest version
cache
...
generate
  ...
  generate:module                 Generates a module
  ...
  generate:service                Generates a service
router
  router:debug                    Displays current routes for an application
  router:rebuild                  Rebuild routes for an application
```
