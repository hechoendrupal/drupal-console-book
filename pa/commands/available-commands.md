...
------------ | -------------
**misc**  |
[about](about.md) | ਡਰੁੱਪਲ ਕੰਸੋਲ ਪ੍ਰਾਜੈਕਟ ਦੇ ਬਾਰੇ ਮੁੱਢਲੀ ਜਾਣਕਾਰੀ ਵੇਖਾਓ
[chain](chain.md) | ਹੁਕਮ ਚਲਾਉਣ ਲਈ ਚੇਨ
...
**debug**  |
[debug:breakpoints](debug-breakpoints.md) | ਵੇਖਾਉਦਾ ਹੈ ਬਰੇਕ ਪੁਆਇੰਟ ਐਪਲੀਕੇਸ਼ਨ ਵਿੱਚ ਉਪਲੱਬਧ
[debug:cache:context](debug-cache-context.md) | Displays current cache context for the application.
[debug:chain](debug-chain.md) | ਉਪਲੱਬਧ ਚੇਨ ਫਾਇਲ ਦੀ ਸੂਚੀ
[debug:config](debug-config.md) | ਮੌਜੂਦਾ ਸੰਰਚਨਾ ਦਿਖਾਓ.
[debug:config:settings](debug-config-settings.md) | ਵੇਖਾਉਦਾ ਹੈ ਮੌਜੂਦਾ key:value ਫਾਇਲ ਸੈਟਿੰਗ ਵਿਚ
